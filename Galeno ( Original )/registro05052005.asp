...
<body>
<FORM action="Registro.asp" method="post" name="frmReg" onSubmit="MM_validateForm('txt_Nombre','','R','txt_Apellido','','R','txt_Especialidad','','R','txt_Sub','','R','txt_consultorio','','R','txt_Piso1','','RisNum','txt_Telefono1','','R','txt_email','','RisEmail');return document.MM_returnValue">
