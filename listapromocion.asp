...
<div id="Layer1" "style="position:absolute; width:845px; height:98px; z-index:1; left: 13px; top: 82px; background-color: #000000; layer-background-color: #000000; border: 1px none #000000; visibility: visible; overflow: scroll;"> 
  ...
  <tr>
    ...
    <% Do while Not rs.EOF %>   
    <tr bgcolor="#CCCCCC"> 
	<td height="59" width="20%"></b><b><font size="1" color =#000000 face="Verdana, Arial, Helvetica, sans-serif"><%=rs("Titulopromocion")%></font></td>
	<td height="59" width="79%"><font size="1"  color=#000000 face="Verdana, Arial, Helvetica, sans-serif"><%=rs("promocion")%></font></td>
    </tr>
    <% rs.MoveNext
	   Loop
	 %>
