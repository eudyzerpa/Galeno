...
<table width="82%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <P>
	<FONT face="Courier New"><B>Introduzca aquí la Comentario del Día:</B></FONT></P>
  ...
  <TR>      
		...
		Titulo de Comentario :</font><font color="#000080">
		</font>
		<FONT 
                    face="Verdana, Arial, Helvetica, sans-serif" color=#996600 
                    size=1><B><font color="#000080"><input type="text" name="txt_titulocomentario" size="66"></font></B></FONT></TD>
        </TR>
      <TR>
        <TD height="51">
		<font face="Courier New">Comentario</font><font color="#000080"><BR>
		<TEXTAREA name=txt_Comentario cols=50 rows="13"></TEXTAREA></font></TD>
      </TR>
      ...
      <P align=center><font color="#000080">&nbsp;&nbsp;
        <input type="submit" name="Submit" value="Enviar Comentario"></font></P></TD>
